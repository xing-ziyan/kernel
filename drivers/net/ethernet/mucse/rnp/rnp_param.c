...
#define RNP_PARAM_INIT { [0 ... RNP_MAX_NIC] = OPTION_UNSET }
	...
	// try to setup new irq mode
        { /* Interrupt Mode */
                ...
                static struct rnp_option opt = {
                        ...
                        .name = "Interrupt Mode",
                        .err =
                          "using default of " __MODULE_STRING(RNP_INT_MSIX),
                        .def = RNP_INT_MSIX,
		...
		opt.arg.r.max = hw->max_vfs;
                ...
                if (num_max_vfs > bd) {
                        ...
                        if (rnp_validate_option(adapter->netdev,
                                                  &vfs, &opt)) {
                                vfs = 0;
                                DPRINTK(PROBE, INFO,
        ...
        { /* Interrupt Mode */
                ...
                static struct rnp_option opt = {
                        ...
                        .name = "SRIOV Mode",
                        .err =
                          "using default of " __MODULE_STRING(RNP_SRIOV_MAC_MODE),
