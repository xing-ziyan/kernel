...
unsigned int rnp_loglevel = 0x00;
 ...
 **/
__maybe_unused static s32 rnp_detect_eeprom_page_size_generic(struct rnp_hw *hw, u16 offset)
{
	return -EINVAL;
}
 ...
 **/
__maybe_unused static s32 rnp_poll_eerd_eewr_done(struct rnp_hw *hw, u32 ee_reg)
{
	return -EINVAL;
}
 ...
 **/
__maybe_unused static void rnp_shift_out_eeprom_bits(struct rnp_hw *hw, u16 data, u16 count)
{
}
 ...
 *  @hw: pointer to hardware structure
 **/
__maybe_unused static u16 rnp_shift_in_eeprom_bits(struct rnp_hw *hw, u16 count)
{
 ...
 **/
__maybe_unused static void rnp_raise_eeprom_clk(struct rnp_hw *hw, u32 *eec)
{
}
 ...
 **/
__maybe_unused static void rnp_lower_eeprom_clk(struct rnp_hw *hw, u32 *eec)
{
}
 ...
 *  advertised settings
 **/
__maybe_unused static s32 rnp_negotiate_fc(struct rnp_hw *hw,
		u32 adv_reg,
		u32 lp_reg,
		u32 adv_sym,
		u32 adv_asm,
