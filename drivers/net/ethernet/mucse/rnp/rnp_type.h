...
#define PCI_DEVICE_ID_N500 0x8308
/* Wake Up Control */
...
struct rnp_eth_operations {
	...
	// ntuple function
	void (*set_layer2_remapping)(struct rnp_eth_info *, union rnp_atr_input *, u16, u8, bool);
	void (*clr_layer2_remapping)(struct rnp_eth_info *, u16);
	void (*clr_all_layer2_remapping)(struct rnp_eth_info *);
	void (*set_tuple5_remapping)(struct rnp_eth_info *, union rnp_atr_input *, u16, u8, bool);
...
struct rnp_hw_operations {
	...
	s32 (*check_link)(struct rnp_hw *, rnp_link_speed *, bool *, bool *,  bool);
	...
	// ntuple function
	void (*set_layer2_remapping)(struct rnp_hw *, union rnp_atr_input *, u16, u8, bool);
	void (*clr_layer2_remapping)(struct rnp_hw *, u16);
	void (*clr_all_layer2_remapping)(struct rnp_hw *);
	void (*set_tuple5_remapping)(struct rnp_hw *, union rnp_atr_input *, u16, u8, bool);
