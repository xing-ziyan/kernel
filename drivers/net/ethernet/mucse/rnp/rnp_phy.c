 ...
 *
 **/
__maybe_unused static enum rnp_phy_type rnp_get_phy_type_from_id(u32 phy_id)
{
 ...
 **/
__maybe_unused static s32 rnp_clock_in_i2c_byte(struct rnp_hw *hw, u8 *data)
{
	s32 i;
	bool bit = false;
 ...
 **/
__maybe_unused static s32 rnp_clock_out_i2c_byte(struct rnp_hw *hw, u8 data)
{
	s32 status = 0;
#if 0
	s32 i;
 ...
 **/
__maybe_unused static s32 rnp_clock_out_i2c_bit(struct rnp_hw *hw, bool data)
{
	s32 status = 0;
#if 0
	u32 i2cctl = RNP_READ_REG(hw, RNP_I2CCTL);
 ...
 **/
__maybe_unused static void rnp_raise_i2c_clk(struct rnp_hw *hw, u32 *i2cctl)
{
#if 0
	u32 i = 0;
 ...
 **/
__maybe_unused static void rnp_lower_i2c_clk(struct rnp_hw *hw, u32 *i2cctl)
{
#if 0
	*i2cctl &= ~RNP_I2C_CLK_OUT;
 ...
 **/
__maybe_unused static s32 rnp_set_i2c_data(struct rnp_hw *hw, u32 *i2cctl, bool data)
{
	s32 status = 0;
#if 0
	if (data)
