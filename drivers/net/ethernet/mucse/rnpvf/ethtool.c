...
void
rnpvf_get_ringparam(struct net_device *netdev,
...
__maybe_unused static int rnpvf_set_ringparam(struct net_device *netdev,
			       struct ethtool_ringparam *ring)
{
	struct rnpvf_adapter *adapter = netdev_priv(netdev);
...
// ethtool -d rnpvf
__maybe_unused static void rnpvf_get_regs(struct net_device *netdev, struct ethtool_regs *regs,
			   void *p)
{
//	struct rnpvf_adapter *adapter = netdev_priv(netdev);
//	struct rnpvf_hw *hw = &adapter->hw;
